...
public class Main {
    ...
    public static boolean runLockerManagement = true;
    ...
    public static void main(String[] args) {
        ...
        while (runLockerManagement) { // main menu
            ...
            try {
                switch (choice) {
                    ...
                    case 5: // display all lockers
                        ...
                        break;
                    case 6:
                        runLockerManagement = false;
                        break;
                    default:
                        System.out.println("Please enter 1-6 only");
                }
            } catch (NumberFormatException e) { // throws when not a number input
